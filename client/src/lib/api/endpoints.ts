...
export const dashboardApi = {
    ...
    getInventory: (params?: { q?: string; limit?: number }) => client.get<{ success: boolean; data: { inventory: any[] } }>("api/v1/dashboard/inventory", { params }),
    getSuggestions: () => client.get<{ success: boolean; data: { suggestions: any[]; returns: any[] } }>("api/v1/dashboard/suggestions"),
