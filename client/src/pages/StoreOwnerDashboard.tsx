...
import { Store, ShoppingCart, TrendingUp, Users, Package, DollarSign, Activity, BarChart3 } from "lucide-react";

const StoreOwnerDashboard: React.FC = () => {
    const auth = useRecoilValue(authState);

    const stats = [
        { icon: DollarSign, label: "Today's Revenue", value: "$0", color: "from-emerald-500 to-teal-500", change: "+0%" },
        { icon: ShoppingCart, label: "Orders Today", value: "0", color: "from-blue-500 to-cyan-500", change: "+0%" },
        { icon: Package, label: "Products", value: "0", color: "from-purple-500 to-pink-500", change: "" },
        { icon: Users, label: "Customers", value: "0", color: "from-orange-500 to-red-500", change: "+0%" },
    ];
            ...
            <div className="max-w-7xl mx-auto px-6 py-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                    ...
                    >
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            ...
                            <button className="p-4 bg-gradient-to-br from-blue-50 to-cyan-50 border border-blue-200/50 rounded-xl text-left hover:shadow-lg transition-all group">
                                ...
                                <h3 className="font-semibold text-slate-800 text-sm">New Sale</h3>
                            </button>
                            ...
                            <button className="p-4 bg-gradient-to-br from-orange-50 to-red-50 border border-orange-200/50 rounded-xl text-left hover:shadow-lg transition-all group">
                    ...
                    >
                        ...
                        <div className="h-48 flex items-center justify-center bg-gradient-to-br from-emerald-50 to-teal-50 rounded-xl">
                            <div className="text-center">
                                <Activity className="w-12 h-12 text-emerald-600 mx-auto mb-2" />
                ...
                >
                    ...
                    <div className="text-center py-12">
                        ...
                        <p className="text-sm text-slate-400 mt-1">Your store activities will appear here</p>
                    </div>
                </motion.div>
